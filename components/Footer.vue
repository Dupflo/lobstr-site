  ...
  <footer>
    ...
    <div class="container">
      ...
      <div class="column">
        <div class="reseaux">
          <h3>Keep In Touch</h3>
          <i class="fa-brands fa-github-alt social fa-2x"></i>
          <i class="fa-brands fa-twitter social fa-2x"></i>
          <i class="fa-brands fa-linkedin-in social fa-2x"></i>
        </div>
      </div>
